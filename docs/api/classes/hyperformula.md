...
**`throws`** [SheetSizeLimitExceededError](sheetsizelimitexceedederror.md) when sheet size exceeds the limits
...
**`throws`** [ExpectedValueOfTypeError](expectedvalueoftypeerror.md) when some parameters of config are of wrong type (e.g., currencySymbol)
...
**`throws`** [EvaluationSuspendedError](evaluationsuspendederror.md) when the evaluation is suspended
...
**`throws`** [ExpectedValueOfTypeError](expectedvalueoftypeerror.md) if source or target are of wrong type
...
**`throws`** [ExpectedValueOfTypeError](expectedvalueoftypeerror.md) if source is of wrong type
...
See [setRowOrder](hyperformula.md#setroworder) for details.
...
**`throws`** [SourceLocationHasArrayError](sourcelocationhasarrayerror.md) when the source location has array inside - array cannot be moved
...
**`throws`** [InvalidArgumentsError](invalidargumentserror.md) when rowMapping does not define correct row permutation for some subset of rows of the given sheet
...
See [setColumnOrder](hyperformula.md#setcolumnorder) for details.
...
**`throws`** [InvalidArgumentsError](invalidargumentserror.md) when columnMapping does not define correct column permutation for some subset of columns of the given sheet
...
**`throws`** [ExpectedValueOfTypeError](expectedvalueoftypeerror.md) if cellAddress is of wrong type
...
**`throws`** [ExpectedValueOfTypeError](expectedvalueoftypeerror.md) when cellAddress is of incorrect type
...
**`throws`** [ExpectedValueOfTypeError](expectedvalueoftypeerror.md) if destinationLeftCorner or source are of wrong type
...
**`throws`** [InvalidArgumentsError](invalidargumentserror.md) when the value is not an array of arrays or a raw cell value
...
**`fires`** [namedExpressionAdded](../interfaces/listeners.md#namedexpressionadded) always, unless [batch](hyperformula.md#batch) mode is used

**`fires`** [valuesUpdated](../interfaces/listeners.md#valuesupdated) if recalculation was triggered by this change

**`throws`** [ExpectedValueOfTypeError](expectedvalueoftypeerror.md) if any of its basic type argument is of wrong type

**`throws`** [NamedExpressionNameIsAlreadyTakenError](namedexpressionnameisalreadytakenerror.md) when the named-expression name is not available.

**`throws`** [NamedExpressionNameIsInvalidError](namedexpressionnameisinvaliderror.md) when the named-expression name is not valid
...
**`throws`** [NamedExpressionDoesNotExistError](namedexpressiondoesnotexisterror.md) when the given expression does not exist.
...
**`throws`** [ExpectedValueOfTypeError](expectedvalueoftypeerror.md) if any of its basic type arguments is of wrong type.

**`throws`** [NotAFormulaError](notaformulaerror.md) when the provided string is not a valid formula (i.e., doesn't start with `=`).

**`throws`** [NoSheetWithIdError](nosheetwithiderror.md) when the provided `sheetID` doesn't exist.
...
registered with [registerFunctionPlugin](hyperformula.md#static-registerfunctionplugin) or [registerFunction](hyperformula.md#static-registerfunction) afterwards reaches only the engines built
...
**`throws`** [ExpectedValueOfTypeError](expectedvalueoftypeerror.md) if address is not [SimpleCellAddress](../interfaces/simplecelladdress.md) or [SimpleCellRange](../interfaces/simplecellrange.md)
...
**`throws`** [ExpectedValueOfTypeError](expectedvalueoftypeerror.md) if address is of wrong type
...
- It must be the **canonical (English) id, never a localized name**. `localizedName` is output only: under
  ...
  returns `undefined`. To look up an entry from [getAvailableFunctions](hyperformula.md#getavailablefunctions), pass its `canonicalName`.
...
**`throws`** [NotAFormulaError](notaformulaerror.md) when the provided string is not a valid formula, i.e., does not start with "="
...
**`throws`** [ExpectedValueOfTypeError](expectedvalueoftypeerror.md) if its arguments are of wrong type
...
**`throws`** [NothingToPasteError](nothingtopasteerror.md) when clipboard is empty

**`throws`** [TargetLocationHasArrayError](targetlocationhasarrayerror.md) when the selected target area has array inside
...
To resume the evaluation use [resumeEvaluation](hyperformula.md#resumeevaluation).
...
**`throws`** [LanguageNotRegisteredError](languagenotregisterederror.md) when trying to retrieve not registered language
...
**`throws`** [FunctionPluginValidationError](functionpluginvalidationerror.md) when function with a given id does not exist in plugin or plugin class definition is not consistent with metadata

**`throws`** [ProtectedFunctionTranslationError](protectedfunctiontranslationerror.md) when trying to register translation for protected function
...
**`throws`** [LanguageAlreadyRegisteredError](languagealreadyregisterederror.md) when given language is already registered
...
**`throws`** [LanguageNotRegisteredError](languagenotregisterederror.md) when given language is not registered
